...
const DATASET_ID = '';
const SCRAPED_DATASET_VECTOR_FIELD = '';
...
Re-word this slug into a question that you might ask to find this page. You will be asking this question to a chunked version of the website, using vector similarity search.`,
      system_prompt: `You are a user looking for a page on a website.`,
    });
...
QUESTION: ${slugQuestion}`,
      ...
      system_prompt: "You are a world class consultant. You answer questions based on context. Do not guess, only answer based on the context. Do not share links. You should use markdown in your responses."
    });
